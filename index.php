        ...
        <div class="contents">
            ...
            <?php if(is_month() ): ?>
                <h1 class="archive-title">
                    ...
                    <?php echo get_the_date('Y年n月'); ?>の記事
                </h1>
            <?php endif; ?>
            ...
            <div class="pagenav">
                <span class="old">
                    <?php next_posts_link('<i class="fa fa-chevron-circle-left"></i> 前の記事'); ?>
                </span>
                <span class="new">
                    <?php previous_posts_link('次の記事 <i class="fa fa-chevron-circle-right"></i>'); ?>
                </span>
            </div>
            <?php endif; ?>
        </div>
